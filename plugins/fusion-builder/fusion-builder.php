...
if ( ! defined( 'FUSION_BUILDER_VERSION' ) ) {
	define( 'FUSION_BUILDER_VERSION', '1.1.4' );
}
// Plugin Folder Path.
...
if ( ! class_exists( 'FusionBuilder' ) ) :
	...
	class FusionBuilder {
		...
		private function __construct() {
			self::$js_folder_url = FUSION_BUILDER_PLUGIN_URL . 'assets/js/min';
			self::$js_folder_path = FUSION_BUILDER_PLUGIN_DIR . 'assets/js/min';
